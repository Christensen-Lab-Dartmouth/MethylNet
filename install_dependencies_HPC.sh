python basic_installer.py -p Rcpp simpleCache BiocManager devtools Cairo remotes knitr markdown gridExtra multcomp fastICA statmod lme4 base64enc ggpubr
